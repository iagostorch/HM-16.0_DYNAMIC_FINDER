...
ultraResVideoList = ['Traffic_2560x1600_30_crop.yuv']
...
for video in medResVideoList:
	for qp in QPList:
		...
		cmd = "./TAppEncoderStatic -c ../cfg/encoder_lowdelay_main.cfg -c ../cfg/per-sequence/" + videoName + ".cfg --TileUniformSpacing=0 --NumTileColumnsMinus1=1 --NumTileRowsMinus1=1  --FramesToBeEncoded=2 --QP=" + str(qp) + " --InputFile=" + path + video + " >> summary.txt"
		print cmd
		os.system(cmd)
		...
		print cmd
		os.system(cmd)
		cmd = "mv " + videoName + "_QP" + str(qp) +  "_time_perCU.txt /home/iagostorch/ICIP2016/SIMULACOES_2X2_OPTIMAL/"	#MOVE THE FILE TO RESULTS FOLDER
		print cmd
		os.system(cmd)
		...
		print cmd
		os.system(cmd)
		cmd = "mv " + videoName + "_QP" + str(qp) +  "_time_perTile.csv /home/iagostorch/ICIP2016/SIMULACOES_2X2_OPTIMAL/"	#MOVE THE FILE TO RESULTS FOLDER
		print cmd
		os.system(cmd)
		...
		print cmd
		os.system(cmd)
		cmd = "mv " + videoName + "_QP" + str(qp) +  "_summary.txt /home/iagostorch/ICIP2016/SIMULACOES_2X2_OPTIMAL/"
		print cmd
		os.system(cmd)
